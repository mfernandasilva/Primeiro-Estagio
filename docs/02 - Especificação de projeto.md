...
| RF-009 (Sistema de Avaliações e Feedback) | A aplicação deve permitir que estagiários e empresas avaliem e forneçam feedback mútuo após o término do estágio. | MÉDIA | 
...
| RF-011 (Integração com Redes Sociais) | A aplicação deve permitir que os usuários se cadastrem e façam login utilizando suas contas de redes sociais como LinkedIn, Facebook ou Google. | MÉDIA | 
